...
#      ansible.playbook = "deploy_springbootmsg.yml"
##     ansible.groups = {
...
# end
  config.vm.define "springbootmsg" do |springbootmsg|
    springbootmsg.vm.box = "clouddood/RH7.5_baserepo"
    springbootmsg.vm.hostname = "springbootmsg"
    springbootmsg.vm.network "private_network", ip: "192.168.60.167"
#   springbootmsg.vm.network "private_network", ip: "192.168.60.167", nic_type: "virtio"
    springbootmsg.vm.provision "shell", :inline => "sudo echo '192.168.60.167 springbootmsg.local springbootmsg' >> /etc/hosts"

##  Use Main / Update in Vagrant provision command ### $vagrant provision --provision-with shell/main/update

    # Default
    springbootmsg.vm.provision "main", type: "ansible" do |ansible|
      ansible.playbook = "deploy_springbootmsg_DEV.local.yml"
#     ansible.playbook = "deploy_springbootmsg_DEV.local.yml"
#     ansible.playbook = "deploy_springbootmsgTestRH7.yml"
      ansible.inventory_path = "vagrant_hosts"
    ...
    # Update
#   springbootmsg.vm.provision "update", type: "ansible" do |ansible|
